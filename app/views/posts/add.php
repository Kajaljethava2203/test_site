<?php require APPROOT . '/views/inc/header.php'?>
    <a href="<?php echo URLROOT; ?>/posts" class="btn btn-light"><i class="fa fa-backward"></i> Back</a>
        <div class="card card-body bg-light mt-5">
            <h2 style="color: blue;text-align: center">Add Issues</h2>
            <p>Create a issues with this form</p>
            <form action="<?php echo URLROOT;?>/posts/add" method="post">
                <div class="form-group">
                    ...
                    <input type="text" name="contact" class="form-control form-control-lg <?php echo (!empty($data['contact_err'])) ? 'is-invalid' : '';?>">
                    <span class="invalid-feedback"><?php echo $data['contact_err']; ?></span>

                    <label for="flat_no" style="color: black">Flat No : </label>
                    <input type="text" name="flat_no" class="form-control form-control-lg <?php echo (!empty($data['flat_no_err'])) ? 'is-invalid' : '';?>" >
                    ...
                    <textarea name="issue" class="form-control form-control-lg <?php echo (!empty($data['issue_err'])) ? 'is-invalid' : '';?>"></textarea>
